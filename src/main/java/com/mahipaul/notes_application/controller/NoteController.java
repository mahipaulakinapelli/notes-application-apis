...
public class NoteController {
  ...
  public ResponseEntity<NotesDto> createNote(
      @RequestBody NotesDto notesdto, @RequestParam("email") String email) {
    NotesDto note = notesService.createNote(notesdto, email);
  ...
  public ResponseEntity<NotesDto> updateNote(
      @RequestBody NotesDto notes, @RequestParam("noteId") UUID notesId) {
